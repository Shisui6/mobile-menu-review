...
<details>
  ...
  <ul>
    <li><a href="#-portfolio-website-">📖 Portfolio Website</a></li>
...
- Simple webpage which displays a list of projects using grid and flexbox
...
```sh
  git clone https://github.com/Shisui6/mobile-menu-review.git
```
